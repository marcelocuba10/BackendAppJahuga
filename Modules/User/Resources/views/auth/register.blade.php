...
@section('content')
    ...
    <div class="registration-form-2">
        <form class="m-t" role="form" method="post" action="/user/register">
            <div class="form-icon">
            ...
            <a class="btn btn-sm btn-white btn-block" style="text-decoration: underline;" href="/user/login">Sign In</a>
        </form>
