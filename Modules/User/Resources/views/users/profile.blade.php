                        ...
                        <form method="get">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <a href="{{ route('users_.edit.profile', $user->id) }}"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-pencil" aria-hidden="true"></i> Update Information</button></a>
                                </div>
                            </div>
                        </form>
                    </div>
