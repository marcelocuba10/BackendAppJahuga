    ...
    Route::group(['middleware' => ['auth:web']], function () {
        ...
        Route::group(['prefix' => 'ACL'], function () {
            Route::group(['prefix' => 'roles'], function () {
                ...
                Route::get('/show/{id}', 'ACL\RolesController@show')->name('roles.user.show');
                ...
                Route::delete('/delete/{id}', 'ACL\RolesController@destroy')->name('roles.user.destroy');
            ...
            Route::group(['prefix' => 'permissions'], function () {
                ...
                Route::get('/show/{id}', 'ACL\PermissionsController@show')->name('permissions.user.show');
                ...
                Route::delete('/delete/{id}', 'ACL\PermissionsController@destroy')->name('permissions.user.destroy');
        ...
        Route::group(['prefix' => 'registers'], function () {
            ...
            Route::group(['prefix' => 'users'], function () {
                ...
                Route::get('/profile/{id}', 'UserController@showProfile')->name('users_.show.profile');
